...
class TestAuto < Test::Unit::TestCase
  ...
  def setup
    @auto1 = Auto.new(id:0,
	  ...
	  @auto2 = Auto.initialization("1,2,Higlander,gray")
  end
  ...
  def test_initialize_auto2
    ...
    assert_equal("Higlander", @auto2.model)
  ...
  def test_to_s
	...
	assert_equal("Higlander gray", @auto2.to_s)
  end

  
  def test_get_info
	 assert_equal("2, Higlander, gray", @auto2.get_info())
  end
