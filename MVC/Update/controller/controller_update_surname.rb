...
class Controller_update_surname< Student_list_controller
	...
	def update_student(id,student)
		stud = Student.new(id:id,surname:student["surname"],name:student["name"],lastname:student["lastname"],phone:student["phone"],telegram:student["telegram"],mail:student["mail"],git: student["git"])
		@student_list.replace_element_by_id(id,stud)
