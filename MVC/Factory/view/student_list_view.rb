...
class Student_list_view < FXMainWindow
	attr_writer :student_list_controller, :modal_window_create_student, :modal_window_change_student
  ...
  private 
	attr_accessor :max_page_data
	attr_writer :count_records, :num_page
	attr_reader :modal_window_create_student, :modal_window_change_student,:student_list_controller
